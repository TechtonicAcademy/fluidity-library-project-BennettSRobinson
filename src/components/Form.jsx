...
const Form = ({ id, form }) => {
  ...
  useEffect(() => {
    if (form === 'edit' && id !== 0) {
      getBook(id)
        ...
        .then(({ data: book }) => setEditBook(book))
  ...
  const { title, author, summary, published, pages, rating } = editBook;
  ...
  const handleRating = (star) => {
    setEditBook((prev) => ({ ...prev, rating: star }));
  };
          ...
          <form className="addBook__forms" onSubmit={handleSubmit}>
            <label htmlFor="title" className="addBook__forms__wrapper">
              ...
              <input
                ...
                defaultValue={form === 'edit' ? title : undefined}
            ...
            <label htmlFor="author" className="addBook__forms__wrapper">
              ...
              <input
                ...
                type="text"
                className="addBook__forms__input"
                defaultValue={form === 'edit' ? author : undefined}
                onChange={handleChange}
                name="author"
                ref={authorRef}
              />
            ...
            <label htmlFor="summary" className="addBook__forms__wrapper">
              ...
              <textarea
                ...
                defaultValue={form === 'edit' ? summary : undefined}
                onChange={handleChange}
                name="summary"
                ref={summaryRef}
              />
            ...
            <div className="addBook__forms__wrapper addBook__forms__wrapper--published">
              <label htmlFor="published" className="addBook__forms__wrapper">
                ...
                <input
                  ...
                  defaultValue={form === 'edit' ? published : undefined}
                  onChange={handleChange}
                  name="published"
                  ref={publishedRef}
                />
              ...
              <label htmlFor="pages" className="addBook__forms__wrapper ">
                ...
                <input
                  ...
                  type="number"
                  className="addBook__forms__input addBook__forms__input--calendar"
                  defaultValue={form === 'edit' ? pages : undefined}
                  onChange={handleChange}
                  name="pages"
                  ref={pagesRef}
                />
